...
public class TAB {
    ...
    public static final Pose2d ROIpose = new Pose2d(33.0, -63.0, Math.toRadians(0.0));
    // blue observation zone init
    public static final Pose2d BOIpose = new Pose2d(-33.0, 63.0, Math.toRadians(180.0));


    // Bucket Poses
    public static final Pose2d RBpose = new Pose2d(-50.0, -50.0, Math.toRadians(225));
    ...
    public static final Pose2d FS8pose = new Pose2d(-52.0, -30.0, Math.toRadians(45));
