...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = -5.156476696914779; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = -0.42880153514554914;

        // feedforward parameters (in tick units)
        public double kS = 1.824069300583843;
        public double kV = -3.804087619348905;
        public double kA = 0;
